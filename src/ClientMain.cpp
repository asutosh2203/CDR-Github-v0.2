...
int main(int argc, char *argv[])
{
    try
    {
        if (argc == 3)
        {
            ...
            if (!ut.validateIP(argv[1]))
            {
                throw("Invalid IP Address");
            }
            if (port > 0)
            {
                newClient.setIPAddr(argv[1]);
                                                ...
                                                while (1)
                                                {
                                                    ...
                                                    case 1:
                                                        ...
                                                        if (strcmp(buf, "searchmsisdn") == 0)
                                                        {
                                                            ...
                                                            cout << endl
                                                                 << "Search Result for MSISDN: " << MSISDN << endl;
                                                            cout << buf << endl;
                                                        }
                                                ...
                                                while (1)
                                                {
                                                    ...
                                                    case 1:
                                                        ...
                                                        if (strcmp(buf, "searchbrand") == 0)
                                                        {
                                                            ...
                                                            cout << endl
                                                                 << "Search Result for Brand Name: " << brandName << endl;
                                                            cout << buf << endl;
                                                        }
                                                        pressEnter();
            ...
            {
                throw("Inavlid PORT Number");
            }
        }
        else
        {
            throw("Inavlid number of arguments");
        }
    }
